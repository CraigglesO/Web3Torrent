...
var TextBond = exports.TextBond = function (_React$Component2) {
	...
	function TextBond() {
		...
		var _this8 = _possibleConstructorReturn(this, (TextBond.__proto__ || Object.getPrototypeOf(TextBond)).call(this));
	...
	_createClass(TextBond, [{
		...
		value: function fixValue(v) {
			if (this.props.bond instanceof _oo.Bond && (typeof this.props.validator !== 'function' || this.props.validator(v))) this.props.bond.changed(v);else this.props.bond.reset();
		}
	}, {
		key: 'componentWillMount',
		value: function componentWillMount() {
